...
%fileID=fopen('TreeGraphParams_pca.txt','r'); %change to read whatever parameters you want
%lines_pca=textscan(fileID,'%s%f%f');
%fclose(fileID);
%Params=[lines_pca{2} lines_pca{3}];
%fileID=fopen('Tree_pca_pam.txt','r'); %change to read whatever parameters you want
